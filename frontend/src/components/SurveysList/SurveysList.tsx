import { Alert, Box, Button, Header, Pagination, Table } from "@awsui/components-react";
...
const SurveysList: FC<SurveysListProps> = (props) => {
    ...
    const fetchSurveys = async () => {
        ...
        return axios.get(appConfiguration.api_endpoint + 'get_data').then((res) => {
            console.log(res?.data,"ch1")
            const surveysList: SurveyModel[] = res.data.map((o: any) => {
    ...
    console.log(surveys,selectedItems,"surve")
